...
def main():
    ...
    goal_pose.append(navigator.getPoseStamped([-3.7, 0.09], TurtleBot4Directions.WEST))
    goal_pose.append(navigator.getPoseStamped([-0.22, 2.49], TurtleBot4Directions.SOUTH))
    goal_pose.append(navigator.getPoseStamped([1.93, 3.32], TurtleBot4Directions.EAST))
    goal_pose.append(navigator.getPoseStamped([-0.9, 0.36], TurtleBot4Directions.NORTH))
