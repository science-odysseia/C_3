                ...
                if click:
                    ...
                    if x < rgb_display.shape[1] and y < rgb_display.shape[0] \
                        ...
                        if 0.2 < z < 5.0:  # Valid range filter
                            ...
                            yaw = 0.0                   # this may be removed when using amcl_pose orientation
                            qz = math.sin(yaw / 2.0)    # replace this with amcl_pose orientation z
                            qw = math.cos(yaw / 2.0)    # replace this with amcl_pose orientation w
