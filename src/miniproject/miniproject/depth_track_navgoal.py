...
STOP_DISTANCE = 1.2      # m, 이 거리 이하이면 정지
PROCESS_PERIOD = 0.5     # sec, 거리 계산 + goal 갱신 주기
DISPLAY_PERIOD = 0.1     # sec, GUI 화면 갱신 주기
...
class CenterToNavGoal(Node):
    ...
    def update_display(self):
        ...
        status = f'goal_sent: {goal_sent}, stopped: {stopped}, follow: {follow_mode}'
        cv2.putText(
            rgb_display,
            status,
            (20, 40),
