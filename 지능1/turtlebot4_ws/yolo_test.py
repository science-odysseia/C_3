...
LAUNCH_COMMAND = "ros2 launch miniproject initiating.launch.py"
    ...
    while True:
        ...
        if detected:
            ...
            if elapsed >= DETECT_SECONDS:
                print(f"0번 클래스가 {CONF_THRESHOLD} 이상으로 {DETECT_SECONDS}초 이상 탐지됨")
                print("새 터미널에서 ROS2 launch 실행 후 감지 코드 종료")
